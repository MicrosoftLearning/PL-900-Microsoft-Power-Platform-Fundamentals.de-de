...
9. Klicken Sie auf **Speichern** und warten Sie, bis die Änderungen gespeichert sind.
...
5. Wählen Sie im Bildschirm „Seite hinzufügen“ die Option **Dataverse-Tabelle** aus, und klicken Sie dann auf die Schaltfläche **Weiter**.
...
11. Wählen Sie im Navigationsbereich unter der Gruppe „Sicherheit“ **SubArea1** aus. 

12. Wählen Sie die **Auslassungspunkte** aus, und wählen Sie im angezeigten Menü **Aus Navigation entfernen** aus. 

13. Klicken Sie auf **Speichern**, und warten Sie, bis die Änderungen gespeichert sind. 
...
### <a name="task-2-test-app"></a>Aufgabe 2: Testen der App
